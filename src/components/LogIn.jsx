  ...
  return (
    <div className='w-35 h-60 bg-slate-600 rounded-3xl bg-grayFG'>
        <form onSubmit={onSubmit} className='h-full w-full'>
            <div className='w-full h-3 mt-8 flex justify-center items-center'>
                <p className='font-bold text-xl text-white'>LOGIN</p>
            </div>
            <div className='w-full h-10 mt-10 flex justify-center items-center'>
                <input onChange={handleOnChange} type='email' placeholder='E-mail' className='w-11/12 h-100  px-4 text-black rounded-xl' 
                name='email' id='email'></input>
            </div>
            <div className='w-full h-10 mt-20 flex justify-center items-center'>
                <input onChange={handleOnChange} type='password' placeholder='Password' className='w-11/12 h-100  px-4 text-black rounded-xl' 
